...
static const struct drm_encoder_funcs mgag200_g200eh5_dac_encoder_funcs = {
	MGAG200_DAC_ENCODER_FUNCS,
};

static const struct drm_connector_helper_funcs mgag200_g200eh5_vga_connector_helper_funcs = {
	MGAG200_VGA_CONNECTOR_HELPER_FUNCS,
};

static const struct drm_connector_funcs mgag200_g200eh5_vga_connector_funcs = {
...
static int mgag200_g200eh5_pipeline_init(struct mga_device *mdev)
{
	...
	ret = drm_encoder_init(dev, encoder, &mgag200_g200eh5_dac_encoder_funcs,
	...
	ret = drm_connector_init_with_ddc(dev, connector,
					  &mgag200_g200eh5_vga_connector_funcs,
	...
	drm_connector_helper_add(connector, &mgag200_g200eh5_vga_connector_helper_funcs);
