...
// XXX hci_req_sync_lock() isn't exposed in the public header as of this code,
// so include from the local net/bluetooth directory for now
#include "../../net/bluetooth/hci_request.h"
