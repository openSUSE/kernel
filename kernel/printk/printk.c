						  ...
						  char *dropped_text, bool *handover, int cookie)
{
	...
	return __console_emit_next_record(con, text, ext_text, dropped_text, handover, cookie);
}
...
static bool console_emit_next_record(struct console *con, char *text, char *ext_text,
				     char *dropped_text)
{
	return __console_emit_next_record(con, text, ext_text, dropped_text, NULL, 0);
}
